function PuzzleGUI($container, dimension, size, margin, speed, num_shuffles, solve_func) {
	...
	var list = document.getElementById('move');
	...
	var countUp=function(){
		...
		if(second == 59){
		  ...
		  document.getElementById("timeId").innerText = min+':'+zeroPlaceholder+second;
	}
	...
	$container.find("div").on("click", function() {
		...
		if (direction != null) {
			...
			entry.appendChild(document.createTextNode('TILE  '+num+'  MOVE TO  '+ direction ));
